...
from retrieval import ChunkStore, HybridRetriever, GraphExpander, CrossEncoderReranker, ContextAssembler
...
def main() -> None:
    ...
    candidates = retriever.retrieve(args.query, limit=args.limit)
